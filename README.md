...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/wabondpro-php.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/wabondpro-php)
...
```php
$skeleton = new WabondPro\WabondClient();
echo $skeleton->echoPhrase('Hello, WabondPro!');
```
...
-   [ricardosawir](https://github.com/wabondpro)
